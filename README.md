...
现在也可以在商店买东西，摆进 3D 房间里：21 套 LEGO 主街景系列、6 种原创车型、4 个盲盒系列（共 24 款）、6 款娃娃、10 件装饰摆件、12 件日常家具和 10 件猫猫家具。LEGO 名称与参考图来自官方，房间里的模型为程序生成的简化展示；其他商品为原创设计。商店价格全部是游戏资金，不是零售价。
...
「家具」有沙发、床、衣柜、书桌、餐桌椅等 12 件；「猫猫家具」有猫爬架、猫窝、猫床、猫砂盆、双碗喂食台、饮水机、猫抓柱、隧道、窗边休息架和玩具篮，共 10 件。每件都有独立的 3D 模型，可以旋转查看，购买后摆放。新增商品都是原创游戏家具，价格是游戏资金。
