...
export function createShop({getState,mutate,getPerson,getError,showInRoom,toast}){
  ...
  function render(force=false){
    ...
    $('#shop-context').textContent=ownedView?'双方共用仓库，物品可以换房间摆放':category==='cars'?'5 类选配 · 3D 实时预览':category==='blind'?'每盒 6 款 · 每款 1/6 · 会有重复款':'金额均为游戏资金';
