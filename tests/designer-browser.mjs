...
try{
  ...
  await page.locator('[data-design-view="3d"]').click();await expect(page.locator('#design-preview canvas')).toHaveAttribute('data-plan',/^custom-/);await page.locator('#design-preview').screenshot({path:'test-results/designer-preview.png'});await page.locator('#design-roof').check();await page.locator('#design-roof').uncheck();
