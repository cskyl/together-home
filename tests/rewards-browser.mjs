...
try{
  ...
  await local.locator('#study-focus').press('ArrowLeft');await expect(local.locator('#study-focus')).toHaveValue('99');await expect(local.locator('#focus-value')).toHaveText('很投入 · 99');await expect(local.locator('#study-focus')).toHaveAttribute('aria-valuetext','很投入，99/100');
